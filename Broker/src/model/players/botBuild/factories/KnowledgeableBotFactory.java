...
import model.players.marketstrategies.knowledgeableStrategy;

public class KnowledgeableBotFactory extends BotFactory {

	@Override
	public Bot generateBot(Difficulty diff) {
		MarketStrategy ms = new knowledgeableStrategy();
